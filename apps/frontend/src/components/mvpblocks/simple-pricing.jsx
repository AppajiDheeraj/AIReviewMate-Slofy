...
import { Sparkles, ArrowRight, Check, Star, Zap, Shield, Cpu } from "lucide-react";
...
const plans = [
  {
    ...
    description:
      "The perfect plan for hobbyists exploring AI-powered code reviews.",
    features: [
      "50 code reviews / month",
      "Basic Gemini model (1.5 Flash)",
  ...
  },
  {
    ...
    description:
      "Everything a developer or small team needs for scalable, fast AI reviews.",
    features: [
      "Unlimited reviews & faster responses",
  ...
  },
  {
    ...
    description:
      "For power users who want experimental AI models and extended automation.",
    features: [
      "Access to experimental models",
      "Custom fine-tuning & prompt control",
      "Extended compute time & queue access",
      "Sandbox for GitHub / GitLab / Bitbucket",
      "Developer API & beta features",
    ],
    cta: "Join AI Lab",
  },
];
export default function SimplePricing() {
  ...
  return (
    <div className="not-prose relative flex w-full flex-col gap-16 overflow-hidden px-4 py-16 text-center sm:px-8">
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              >
                ...
                <CardHeader className={cn("pb-4", plan.popular && "pt-2")}>
                ...
                <CardFooter>
                  <Button
                    onClick={() => {
                      if (plan.id === "ai-lab") router.push("/waitlist");
                    }}
